...
_.includes = function (arr, target) {
  // TODO: 여기에 코드를 작성합니다.
  return _.reduce(arr, function(acc, cur){return (cur === target) ? acc = true : acc&&true}, false);
};
...
_.zip = function () {
  // TODO: 여기에 코드를 작성합니다.
  let result = [];
  let numArr = _.reduce(arguments, function(acc,cur){acc.push(cur.length); return acc;}, []);
