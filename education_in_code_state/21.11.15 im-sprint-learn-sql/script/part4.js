...
*/
const PART4_3 = `INSERT INTO user (name, email) VALUES ('lee', 'ciociolee@gmail.com')`;
...
----------------------------------------------------------------------------------------------
    TODO: Q 4-7. content의 title과 그 컨텐츠를 작성한 user의 name을 찾기 위한 SQL을 작성해주세요.
        ...
        // 뭐야 ... 왜 통과되는거야 ? join 공부하기 ...
*/
const PART4_7 = `SELECT content.title, user.name FROM user RIGHT JOIN content ON content.userId = user.id`;

/*
----------------------------------------------------------------------------------------------
    TODO: Q 4-8. content의 title과 그 컨텐츠를 작성한 user의 name을 찾기 위한 SQL을 작성해주세요.
        - 저자가 있는 컨텐츠의 title만 찾아야합니다.
        // inner join 과 left join 의 차이를 알았다 .
*/
const PART4_8 = `SELECT content.title, user.name FROM user INNER JOIN content ON content.userId = user.id`;
...
*/
const PART4_10 = `INSERT INTO content (title, body, userId) VALUES ('why so serious', 'OMG', 1)`;
